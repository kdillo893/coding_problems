...
void longestCommonPrefixTest() {
  ...
  // print the "words" array to see if it was destructive, then also print the
  // result..
...
void removeDuplicatesTest() {
  int numsSize = 20;
  int nums[20] = {5, 6, 3,  2, 3,   4,   7,  8,    1, 2,
                  4, 8, 12, 4, 322, 134, 90, 5675, 7, 345}; // Input array
  int expectedNumsSize = 14;
  int expectedNums[14] = {
      5,  6,   3,   2,  4,    7,  8, 1,
      12, 322, 134, 90, 5675, 345}; // The expected answer with correct length
...
void removeElementTest() {
  ...
  int arrSize = 12;
  int arr[12] = {45,   212,   3242, 1234, 4324, 45,
                 6778, 56785, 234,  5454, 1212, 9999};
  int expectedResSize = 10;
  int expectedRes[10] = {212,   3242, 1234, 4324, 6778,
                         56785, 234,  5454, 1212, 9999};
